...
import { Link, Loader2, LockKeyholeIcon } from "lucide-react"
...
<div className="text-center">
    ...
    <p className="text-sm text-gray-400">Enter your new password to reset</p>
</div>
...
{
    loading ?(
      <Button disabled className="bg-orange-400"><Loader2 className="mr-2 h-4 w-4 animate-spin"/>Please wait</Button>
    ):(
      <Button className="bg-orange-500 hover:bg-orange-400">Reset</Button>
    )

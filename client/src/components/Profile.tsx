...
const Profile = () => {
    ...
    return (
        ...
        <form  onSubmit={updateProfileHandler} className="max-w-7xl mx-auto my-5">
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                    <Avatar className="relative md:w-28 md:h-28 w-20 h-20">
                        ...
                        <input ref={imageRef}
                            type="file" className="hidden" accept="image/*" onChange={fileChangeHandler} />
            ...
            <div className="grid md:gtid-cols-4 md:gap-2 gap-3 my-10">
                <div className="flex items-center gap=4 rounded-sm p-2 bg-gray-200">
                    <Mail className="text-gray-500"/>
                    <div className="w-full">
                        <Label>Email</Label>
                        <input name="email" value={profileData.email} onChange={changeHandler} className="w-full text-gray-600 bg-transparent focus-visible:ring-0 focus-visible:border-transparent outline-none border-none" />
                    </div>
                ...
                <div className="text-center">
                    {
                     loading ? 
                        ...
                        <Button disabled className="bg-orange-500 hover:bg-orange-500"><Loader2 className="mr-2 w-4 h-4 animate-spin"/>Please Wait</Button>:<Button className="bg-orange-500 hover:bg-orange-500">Update</Button>
